  ...
  const EmployeeManagement = ({ darkMode, filterText }) => {
    ...
    const fetchEmployees = async (page = 1, limit = pageSize) => {
      try {
        ...
        const response = await axios.get("https://inventoryapps-g67r.onrender.com/api/employees", {
    ...
    //         "https://inventoryapps-g67r.onrender.com/api/employees/add-employee",
    //         employeeData
    //       );
        ...
        try {
          if (editMode) {
            ...
            const response = await axios.put(
              `https://inventoryapps-g67r.onrender.com/api/employees/${currentEmployee._id}`,
              employeeData
            );
    ...
    const handleDelete = async (id) => {
      ...
      try {
        await axios.delete(`https://inventoryapps-g67r.onrender.com/api/employees/${id}`);
