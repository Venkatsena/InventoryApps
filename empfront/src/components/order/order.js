...
//           const response = await axios.get(`https://inventoryapps-g67r.onrender.com/api/appliedProducts/${employeeID}`);
  ...
  const updaterReceivedStatus = async (id, newStatus) => {
    try {
      ...
      const response = await axios.put(
        `https://inventoryapps-g67r.onrender.com/api/appliedProducts/received-status/${id}`,
