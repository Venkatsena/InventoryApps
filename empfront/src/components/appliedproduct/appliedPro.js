...
const AppliedProducts = ({ userData, filterText }) => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const response = await axios.get(
        "https://inventoryapps-g67r.onrender.com/api/products/products",
        {
  ...
  const fetchAllAppliedProducts = async () => {
    try {
      const response = await axios.get(
        "https://inventoryapps-g67r.onrender.com/api/appliedProducts/all"
      );
  ...
  const fetchAppliedProducts = async () => {
    try {
      const response = await axios.get(
        `https://inventoryapps-g67r.onrender.com/api/appliedProducts/${employeeID}`
      );
      setAppliedProducts(response.data);
    } catch (error) {
  ...
  const fetchAllAppliedProduct = async () => {
    try {
      const response = await axios.get("https://inventoryapps-g67r.onrender.com/api/appliedProducts");
...
//       "https://inventoryapps-g67r.onrender.com/api/appliedProducts/apply",
//       {
//         employeeID,
//         employeeName,
...
const checkDisableState = (appliedAt) => {
  ...
  const handleDelete = async (productId,appliedDate) => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.delete(
        `https://inventoryapps-g67r.onrender.com/api/appliedProducts/apply/${productId}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  //   try {
  //     await axios.delete(
  //       `https://inventoryapps-g67r.onrender.com/api/appliedProducts/apply/${id}`
  //     );
  //     setAppliedProducts(
  ...
  //       await axios.put(
  //         `https://inventoryapps-g67r.onrender.com/api/appliedProducts/apply/${editProduct._id}`,
  //         {
  //           quantity,
  //           date,
  //         },
